function(GET_INVALID_CLANG_HEADERS INVALID_CLANG_HEADERS)
  #Execute the clang compiler in verbose mode to find the location of inttypes.h
  if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
    ...
    set(${INVALID_CLANG_HEADERS} ${${INVALID_CLANG_HEADERS}} ${inttypes_c_location} PARENT_SCOPE)
  endif()
  ...
  set(${INVALID_CLANG_HEADERS} ${inttypes_c_location} ${inttypes_cxx_location} PARENT_SCOPE)
endfunction()
